...
The hex plot reveals that, despite some variability, most of the data is tightly clustered in the center of the distribution. Interestingly, in a few rare instances, tmax is lower than tmin, which raises concerns about potential data recording or quality issues.\

The ridge plot displays a multimodal distribution of snowfall within each year. The majority of stations report snowfall between 0 and 35 mm annually. There are additional peaks around 45 mm and near 80 mm. This multimodality may be due to the conversion of measurements from one system (e.g., fractions of an inch) to another (e.g., the metric system), a pattern also observed in the table of common values.
